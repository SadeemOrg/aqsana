...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-link-field', __webpack_require__(3));
  Vue.component('detail-link-field', __webpack_require__(6));
  Vue.component('form-link-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.$nextTick(function () {
            _this.type = _this.value.resource || '';

            if (_this.value.id) {
                _this.selected = {
                    value: _this.value.id
                };
                _this.typeChanged();
            }
        });
    ...
    methods: {
        typeChanged: function typeChanged() {
            ...
            if (this.value.resource && this.value.resource != 'external') {
                var res = this.field.resources.find(function (resource) {
                    return resource.resource == _this2.value.resource;
                });
                this.resources = [];
                if (res.key) {
                    Nova.request().get('/nova-vendor/link/' + res.key).then(function (_ref) {
                        var data = _ref.data;

                        _this2.resources = data;
                        if (_this2.selected) {
                            var find = data.find(function (resource) {
                                return resource.value == _this2.selected.value;
                            });
                            if (find) {
                                _this2.selected = find;
                            };
                        }
                    });
                }
      ...
      _c("template", { slot: "field" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.field.resources, function(resource) {
              return _c("option", { domProps: { value: resource.resource } }, [
                _vm._v(
                  "\n                " +
            ...
            _c("option", { attrs: { value: "external" } }, [
              _vm._v(_vm._s(_vm.__("External Link")))
            ])
          ],
          2
        ),
        _vm._v(" "),
        _vm.value.resource && _vm.value.resource != "external"
          ? _c(
              "div",
              { staticClass: "mt-3" },
              [
