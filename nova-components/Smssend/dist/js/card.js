...
var render = function() {
  ...
  return _c("card", { staticClass: "flex flex-col p-6" }, [
    _c(
      "form",
      {
        attrs: { method: "get" },
      ...
      [
          ...
          _c("div", { staticClass: "relative" }, [
            ...
            _c(
              "div",
              {
                ...
                staticClass:
                  "absolute w-full bg-white border border-gray-200 rounded mt-1 z-10",
        ...
        _c("div", { staticClass: "mb-6" }, [
          ...
          _c(
            "p",
            {
              staticClass: "text-right text-small mt-1",
              class: { "text-red-500": _vm.hasError }
            },
            [
              _vm._v(
                "\n                " +
        ...
        _c(
          ...
          [
            _c(
              ...
              {
                staticClass:
                  "shadow bg-green-600 hover:bg-green-500 focus:shadow-outline focus:outline-none text-white font-bold px-6 py-2 rounded",
                attrs: { type: "submit" },
                on: { click: _vm.send }
              },
              [_vm._v("\n                ارسال\n            ")]
