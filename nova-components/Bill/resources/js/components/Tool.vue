<template>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 -mt-14 px-2">
        <div
            class="flex flex-col items-center justify-center mt-40 max-w-4xl mx-auto"
        ...
        >
            ...
            <div
                class="flex md:flex-row flex-col items-center justify-between md:gap-y-0 gap-y-3  w-full mt-12"
            >
                <div
                ...
                >
                    ...
                    <div
                        class="flex md:flex-row flex-col items-center justify-between  w-full mt-2"
                        style="width:100%"
                    >
                        <form
