...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-bookings-bus', __webpack_require__(3));
  Vue.component('detail-bookings-bus', __webpack_require__(6));
  Vue.component('form-bookings-bus', __webpack_require__(9));
});
    ...
    methods: {
        getBus: function getBus() {
            ...
            axios.post("/getBus", {
                ...
                _this.Bus = response.data;
                console.log("sss", _this.Bus);
            });
        },
        setInitialValue: function setInitialValue() {
            this.value = this.field.value || '', this.getBus();
        },
      ...
      _c("template", { slot: "field" }, [
        _c("div", [
          _c(
            ...
            [
              _c("tr", [
                _c("th", [_vm._v("اسم الباص")]),
                _vm._v(" "),
                _c("th", [_vm._v("عدد المقاعد")]),
                _vm._v(" "),
                _c("th", [_vm._v(" عدد المقاعد المحجوزة")]),
                _vm._v(" "),
                _c("th", [_vm._v(" عدد المقاعد المتبقية")])
              ]),
              _vm._v(" "),
              _vm._l(_vm.Bus, function(item) {
                return _c("tr", { key: item.id }, [
                  _c("td", [_vm._v(_vm._s(item.bus_number))]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.number_of_seats))]),
                  _vm._v(" "),
                  _c("td", [
                    _vm._v(_vm._s(item.number_of_seats - item.number_of_people))
                  ]),
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(item.number_of_people))])
                ])
              })
            ],
            2
...
var update = __webpack_require__(20)("c9c9da74", content, false, {});
