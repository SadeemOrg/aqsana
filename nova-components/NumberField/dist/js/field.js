...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-number-field', __webpack_require__(3));
  Vue.component('detail-number-field', __webpack_require__(6));
  Vue.component('form-number-field', __webpack_require__(9));
});
