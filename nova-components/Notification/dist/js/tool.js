...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__delete_notification_vue__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__delete_notification_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__delete_notification_vue__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { DeleteModal: __WEBPACK_IMPORTED_MODULE_1__delete_notification_vue___default.a },
    data: function data() {
        return {
            users: [],
            myNotification: [],
    ...
    methods: {
        ...
        UNCompletNotifications: function () {
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                _context3.prev = 0;
                                _context3.next = 3;
                                return axios.post("/UNCompletNotifications", {
                            ...
                            case 6:
                                ...
                                toastr.error("An error occurred while uncompleting notification");
            ...
            function UNCompletNotifications(_x) {
                return _ref3.apply(this, arguments);
            }

            return UNCompletNotifications;
        }(),
        receivedNotifications: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee4($event, $type) {
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                _context4.prev = 0;
                                _context4.next = 3;
                                return axios.post("/receivedNotifications", {
                                    Notificationsid: $event
                                });
                            ...
                            case 6:
                                ...
                                toastr.error("An error occurred while processing received notification");
            ...
            function receivedNotifications(_x2, _x3) {
        ...
        WorkOnNotifications: function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee5($event, $type) {
            ...
            function WorkOnNotifications(_x4, _x5) {
                return _ref5.apply(this, arguments);
            }

            return WorkOnNotifications;
        }(),
        CompletNotifications: function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee6($event, $type) {
                    ...
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                _context6.prev = 0;
                                _context6.next = 3;
                                return axios.post("/CompletNotifications", {
                                    Notificationsid: $event
                                });
            ...
            function CompletNotifications(_x6, _x7) {
                return _ref6.apply(this, arguments);
            }

            return CompletNotifications;
        }(),
        ...
        AddNote: function () {
            var _ref8 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee8($event, $note) {
                var response;
      ...
      _c("div", { staticClass: "flex" }, [
        _c("div", { staticClass: "w-full h-full" }, [
          _c(
            ...
            {
              staticClass:
                "flex flex-row xl:flex-nowrap flex-wrap gap-y-3 items-center justify-start w-full my-4 gap-x-2"
            },
            [
              _c(
                "div",
          ...
          _vm._v(" "),
          _c("div", { staticClass: "overflow-x-auto bg-white shadow-lg" }, [
            _c(
              "div",
              {
                staticClass:
                  "relative flex flex-col min-w-0 break-words w-full mb-6 rounded p-4 for-mobile-scroll-x",
                class: {
                      ...
                      return _c("tr", { key: Notification.id }, [
                        ...
                        Notification.status == 1
                          ? _c("td", [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "shadow bg-green-600 focus:shadow-outline focus:outline-none text-white font-bold w-48 py-4 rounded",
                                  attrs: { type: "submit" },
                                  on: {
                                    click: function($event) {
                        ...
                        _c("th", [
                          _c(
                            ...
                            {
                              staticClass:
                                "shadow bg-red-500 hover:bg-red-600 text-sm focus:shadow-outline focus:outline-none text-white px-10 py-4 rounded",
                              attrs: { type: "submit" },
                              on: {
                                click: function($event) {
          ...
          _c("div", { staticClass: "overflow-x-auto bg-white shadow-lg" }, [
            _c(
              ...
              {
                staticClass:
                  "relative flex flex-col min-w-0 break-words w-full mb-6 rounded p-4 for-mobile-scoll-x",
                class: {
