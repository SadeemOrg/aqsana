<template>
    <div>
        ...
        <div class="flex">
            <div class="w-full h-full">
                <div class="flex flex-row xl:flex-nowrap flex-wrap gap-y-3 items-center justify-start w-full my-4 gap-x-2">
                    ...
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/2">
                        <a v-on:click="toggleTabs(2)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md':
                                openTab !== 2,
                            'text-white bg-green-600 w-full py-4 text-center rounded-md':
                                openTab === 2
                    ...
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/2">
                        <a v-on:click="toggleTabs(4)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md':
                                openTab !== 4,
                            'text-white bg-green-600 w-full py-4 text-center rounded-md':
                                openTab === 4
                    ...
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/2">
                        <a v-on:click="toggleTabs(3)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md':
                                openTab !== 3,
                            'text-white bg-green-600 w-full py-4 text-center rounded-md':
                                openTab === 3
                ...
                <div class="overflow-x-auto bg-white shadow-lg">
                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6  rounded p-4 for-mobile-scoll-x"
                        ...
                        <table class="text-center">
                            ...
                            <tr v-for="Notification in myAlertNotification" :key="Notification.id" :value="Notification.id">
                                <td>
                                    {{
                                        Notification.Notifications.Notifications
                                    }}
        ...
        <div v-if="openDeleteModal">
            <delete-modal @handel-close-delete-modal="handelCloseDeleteModal"
                @handel-delete-notification="handelDeleteNotifications"></delete-modal>
        </div>
    </div>
</template>
