...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-sector-picker', __webpack_require__(3));
  Vue.component('detail-sector-picker', __webpack_require__(6));
  Vue.component('form-sector-picker', __webpack_require__(9));
});
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _c("div", { staticClass: "flex gap-x-8 items-center" }, [
          _c("p", { staticClass: "pt-3 min-w-24" }, [_vm._v(" اسم قطاع ")]),
          _vm._v(" "),
          _c(
            "select",
            {
