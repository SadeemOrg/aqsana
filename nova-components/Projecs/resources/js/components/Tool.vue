<template>
    <div>
        <div class="flex ">
            <div class="w-full">
                <div class=" flex flex-row items-center justify-satrt w-full my-4 gap-x-2 ">
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/4">
                        <a class=" " v-on:click="toggleTabs(1)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md': openTab !== 1,
                            'text-white  bg-green-600 w-full py-4 text-center rounded-md': openTab === 1
                        }">
                            الميزانيات
                        </a>
                    </div>
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/4">
                        <a class="" v-on:click="toggleTabs(2)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md': openTab !== 2,
                            'text-white  bg-green-600 w-full py-4 text-center rounded-md': openTab === 2
                        }">
                            اضافة جدييد
                        </a>
                    </div>
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/4">
                        <a class="" v-on:click="toggleTabs(3)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md': openTab !== 3,
                            'text-white  bg-green-600 w-full py-4 text-center rounded-md': openTab === 3
                        }">
                            حذف
                        </a>
                    </div>
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/4">
                        <a class="w-full" v-on:click="toggleTabs(4)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md': openTab !== 4,
                            'text-white  bg-green-600 w-full py-4 text-center rounded-md': openTab === 4
                        }">
                            احصائبات
                        </a>
                    </div>
                    ...
                    <div class="px-4 py-5 flex-auto">
                        <div class="tab-content tab-space">
                            ...
                            <div v-bind:class="{
                                ...
                                <div class="py-4 w-[95%] bg-slate-700">
                                    <select @change="onChange($event)"
                                        ...
                                        <option :value="null" selected disabled>الرجاء اختيار فئة</option>
                                ...
                                <form @submit.prevent="onSubmit" class="add-form py-4">
                                    <div v-for="Sector in Sectors" :key="Sector.Sector" :value="Sector.Sector"
                                    ...
                                    <div v-if="Sectors.length" class="md:flex md:items-center w-11/12 justify-end">
                                        <div class="md:w-2/3">
                                            <button
                            ...
                            <div v-bind:class="{
                                ...
                                <form @submit.prevent="onSubmit" class="add-form py-4">
                                    <div v-for="Sector in newSectors" :key="Sector.Sector" :value="Sector.Sector"
                                        class="md:flex md:items-center mb-6">
                                        <div class="md:w-1/3">
                                            <label
                                                class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4 text-lg w-64"
                                    ...
                                    <div v-if="newSectors.length" class="md:flex md:items-center w-11/12 justify-end">
                                        <div class="md:w-2/3">
                                            <button
                                                class="shadow bg-gray-500 hover:bg-black focus:shadow-outline focus:outline-none text-white font-bold px-16 py-4 rounded"
                            ...
                            <div v-bind:class="{
                                ...
                                <div class="py-4 w-[95%] bg-slate-700">
                                    <select @change="onChangedelet($event)" 
                                ...
                                <form @submit.prevent="onSubmit" class="add-form py-4">
                                    ...
                                    <div v-if="deletSectors.length" class="md:flex md:items-center w-11/12 justify-end">
                                        <div class="md:w-2/3">
                                            <button
                                                class="shadow bg-gray-500 hover:bg-black focus:shadow-outline focus:outline-none text-white font-bold px-16 py-4 rounded"
                                        ...
                                        <div class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row">
                                            <div class="-mb-px mr-2 last:mr-0 flex-auto text-center"
                                                ...
                                                <a class="text-xs font-bold uppercase px-5 py-4 my-2 shadow-lg rounded block leading-normal"
                                                    ...
                                                    "
                                                    v-bind:class="{ 'text-green-600 bg-white cursor-pointer': openTabstatistic !== index, 'text-white bg-green-600 cursor-pointer': openTabstatistic === index }">
                                                    {{ Sector.Sector }}
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="px-4 py-5 flex-auto">
                                                <div class="tab-content tab-space">
                                                    <div v-for="(Sector, index) in budjetSector" :key="Sector.Sector"
                                                        :value="Sector.Sector"
                                                        v-bind:class="{ hidden: openTabstatistic !== index, block: openTabstatistic === index }">
                                                        <p>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="sm:col-span-6">
                                                                            <label for="street-address"
                                                                                class="block text-sm font-medium text-gray-700">ميزانبة
                                                                                القطاع
                                                                            </label>
                                                                            <div class="mt-1">
                                                                        ...
                                                                        <div class="sm:col-span-2">
                                                                            <label for="city"
                                                                                class="block text-sm font-medium text-gray-700">الربع
                                                                                الاول
                                                                                ميزانية
                                                                            </label>
                                                                            <div class="mt-1">
                                                                        ...
                                                                        <div class="sm:col-span-2">
                                                                            ...
                                                                            <div class="mt-1">
                                                                                <input readonly type="text"
                                                                                    name="postal-code" id="postal-code"
                                                                                    autocomplete="postal-code" :value="Sector.Budget / 4 - Sector.expenses_fourth
                                                                                    "
                                                                                    class="p-2 block w-full rounded-md border border-black shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                                                                            </div>
                                                                        </div>
    ...
    methods: {
        ...
        getYears: function () {
            axios.post("/year").then(response => {
                ...
                this.selectedItem = this.years[0];
            });
        },
