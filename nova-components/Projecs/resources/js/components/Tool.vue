        ...
        <div class="flex">
            <div class="w-full">
                <div class="flex flex-row items-center justify-satrt w-full my-4 gap-x-2">
                    ...
                    <div class="flex flex-row items-center justify-center cursor-pointer w-1/4">
                        <a class="" v-on:click="toggleTabs(5)" v-bind:class="{
                            'text-green-600 bg-white w-full py-4 text-center rounded-md':
                                openTab !== 5,
                            'text-white  bg-green-600 w-full py-4 text-center rounded-md':
                                openTab === 5,
                        ...
                        <div class="tab-content tab-space">
                            ...
                            <div v-bind:class="{
                                ...
                                <div class="py-4 w-[95%] bg-slate-700">
                                    ...
                                    <select
                                        class="select1 mt-1 block w-full rounded-md border-2 border-balck px-4 py-2 pl-3 pr-10 text-base max-w-4xl mx-auto focus:border-black focus:outline-none focus:ring-black sm:text-sm"
                                        @change="onChange($event)" v-model="DeleteYear">
                                        <option selected disabled value="0">
                                            Please select one
                                        </option>

                                        <option v-for="DeleteYear in DeleteYears" :key="DeleteYear.year"
                                            :value="DeleteYear.year">
                                            {{ DeleteYear.year }}
                                        </option>
                                    </select>
                                </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="sm:col-span-6">
                                                                            ...
                                                                            <div class="mt-1">
                                                                                <input readonly type="text"
                                                                                    name="street-address"
                                                                                    id="street-address"
                                                                                    autocomplete="street-address" :value="(Sector.Budget - Sector.expenses_year).toFixed(2)
                                                                                        "
                                                                                    class="p-2 block w-full rounded-md border border-black shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="sm:col-span-2">
                                                                            <label for="region"
                                                                                ...
                                                                                الاول مصاريف</label>
                                                                            <div class="mt-1">
                                                                                <input readonly type="text" name="region"
                                                                                    id="region"
                                                                        ...
                                                                        <div class="sm:col-span-2">
                                                                            <label for="postal-code"
                                                                                class="block text-sm font-medium text-gray-700">الربع
                                                                                الاول صافي الانفاق</label>
                                                                            <div class="mt-1">
                                                                                <input readonly type="text"
                                                                                    name="postal-code" id="postal-code"
                                                                                    autocomplete="postal-code" :value="(Sector.Budget / 4 -
                                                        ...
                                                        <div class="md:flex justify-between mt-5 text-center">
                                                            <div class="mb-6 md:mb-0 md:w-1/2">
                                                                <pure-vue-chart class="chart-custom-style"
                                                                    ...
                                                                    :use-month-labels="true" :use-points-labels="true"
                                                                    :months="[
                                                                        'Jan',
                                                                        'Fev',
                                                                        'Mar',
...
export default {
    ...
    methods: {
        ...
        geDeleteYears: function () {
            axios.post("/DeleteYears").then((response) => {
                this.DeleteYears = response.data;
                console.log("delet", this.DeleteYears);
            });
        },
