...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Projecs")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              {
                staticClass:
                  "ml-1 border border-80 text-sm font-mono text-white bg-black  px-2 py-1"
              },
              [
                _c("div", { staticClass: "bg-black ro text-9xl" }, [
                  _vm._v(" ffff")
                ]),
                _vm._v(
