<template>
  <field-wrapper :stacked="field.stacked">
    <div class="px-8" :class="field.stacked ? 'pt-6 w-full' : 'md:py-6 w-1/5 custom-field-style'">
      <slot>
        <form-label
    ...
    <div class="py-6 md:pt-6 pt-3 px-3 md:px-8 custom_defaultField" :class="fieldClasses">
      <slot name="field" />
