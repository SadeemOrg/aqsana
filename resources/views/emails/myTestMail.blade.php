...
<body>
    ...
    <div style="position: absolute;left: 39.5%; top:5%; ">
    ...
    <p style="text-align: center;cursor: pointer; margin-top: 25%;"> To download the Pdf Bilss Just Click here</p>
    <a style="position: absolute; top:60%; left:45%; color: black" href='{{config('app.url').'/generate-pdf/' .$Transaction['id']}}'
        style="text-align: center">Downlaod Pdf</a>
</body>
