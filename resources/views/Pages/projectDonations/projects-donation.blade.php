                ...
                <div class="bg-[#E4FFE585] rounded-[5px] py-3 px-4 h-full">
                    <div class="">
                        ...
                        <p class="text-xs block sm:hidden md:block text-[#101426] font-noto_Regular pl-4 pt-2 text-right slider-paragraph">
                            {{ Illuminate\Support\Str::limit(strip_tags( $Project->report_description),97) }}
                            @if(strip_tags(Str::length($Project->report_description)) > 97)
                            <a href="/" target="_self">
                                <span class="text-[#349A37] text-[12px]">عرض المزيد</span>
                            </a>
                            @endif
                        </p>
                        <div class="flex flex-wrap gap-y-3 justify-center sm:justify-between items-center mt-5">
                            <div class="flex text-center">
                                <a target="_self"
                                    class="bg-[#349A37] hover:bg-[#101426] duration-200 py-3 ml-2 text-white  rounded-[50px] w-[134px] lg:w-[110px] xl:w-[134px] "
                                    href="{{ route('donation', ['id' => $Project->id]) }}">تبرع الان</a>
                            ...
                            <div
                                class="flex flex-row items-center justify-start mt-3 sm:mt-0 font-noto_Regular gap-x-2 mx-5 md:mx-0 ">
                                <p class="text-[#101426] text-sm">شارك عبر</p>
                                <ul class="share-us flex flex-row items-center justify-start">
                                    <li class="px-1">
                                        <a class="facebook"
                                            href="javascript:openWindow('http://www.facebook.com/sharer/sharer.php?u={{ Request::url() }}/{{ $Project->id }} & title=')">
                                    ...
                                    <li class="px-1">
                                        <a class="twitter"
                                            href="javascript:openWindow('http://twitter.com/intent/tweet?text=+{{ Request::url() }}/{{ $Project->id }}')">
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="12.1687" cy="12.1687" r="11.6687" stroke="#101426" />
                                    ...
                                    <li class="px-1">
                                        <a class="pinterest"
                                            href="http://pinterest.com/pin/create/link/?url={{Request::url()}}/{{ $Project->id }}"
                                    ...
                                    <li class="px-1">
                                        <a class="linkedin lisharelink" data-shareurl={{ Request::url() }} data-id={{
                                            $Project->id}} >
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="12.1687" cy="12.1687" r="11.6687" stroke="#101426" />
                                                <path
                                                    ...
                                                    fill="#101426" />
                                                <path d="M7.49487 10.8422H9.69105V17.907H7.49487V10.8422Z"
                                                    fill="#101426" />
                                                <path
