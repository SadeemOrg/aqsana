                    ...
                    <div class="">
                        ...
                        <div class="flex flex-wrap gap-y-3 justify-center sm:justify-between items-center mt-5">
                            <div class="flex text-center">
                                <a target="_self" class="bg-[#349A37] hover:bg-[#101426] duration-200 py-3 ml-2 text-white  rounded-[50px] w-[134px] lg:w-[110px] xl:w-[134px] " href="{{ route('donation', ['id' => $Project->id]) }}">تبرع الان</a>
                                <a class="bg-transparent hover:text-white hover:bg-[#349A37] duration-200 py-3 text-[#349A37] rounded-[50px] w-[134px] lg:w-[110px] xl:w-[134px]  border border-[#349A37]" href="{{ route('getdonationDetail', ['id' => $Project->id]) }}" target="_self">رؤية
                                    التفاصيل</a>
                            </div>
                            <div class="flex flex-col items-start gap-y-2 justify-start mt-3 sm:mt-0 font-noto_Regular gap-x-2 mx-5 md:mx-0 ">
                                <p class="text-[#101426] text-sm">شارك عبر</p>
                                <ul class="share-us flex flex-row items-center justify-start gap-x-2">
                                    <li>
                                        <a class="facebook" href="javascript:openWindow('http://www.facebook.com/sharer/sharer.php?u={{ Request::url() }}/{{ $Project->id }} & title=')">
                                    ...
                                    <li>
                                        <a class="twitter" href="javascript:openWindow('http://twitter.com/intent/tweet?text=+{{ Request::url() }}/{{ $Project->id }}')">
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="12.1687" cy="12.1687" r="11.6687" stroke="#101426" />
