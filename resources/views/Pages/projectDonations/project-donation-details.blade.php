    ...
    <div class="max-w-7xl mx-auto px-4  sm:px-6 lg:px-8">
        ...
        <div class="p-3 bg-white Card_shadow mt-4 lg:mt-16 relative flex flex-col items-center justify-center w-full">
            ...
            <div class="max-w-6xl bg-[#E4FFE585] rounded-[5px] py-3 px-4 ">
                ...
                <div class="flex flex-col sm:flex-row items-start gap-y-2 sm:gap-y-0 sm:items-center justify-start px-4 pt-4 pb-10 font-noto_Regular gap-x-2">
                    ...
                    <ul class="share-us flex flex-row items-center justify-start gap-x-2">
                        ...
                        <li>
                            <a class="twitter" target="_self" href="javascript:openWindow('http://twitter.com/intent/tweet?status=+{{ Request::url() }}')">
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="12.1687" cy="12.1687" r="11.6687" stroke="#101426" />
                ...
                <div class="flex text-center justify-end gap-y-4">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 ">
                    ...
                    <div class="col-span-1 scalabel-img-box">
                        <a href={{ $project->report_video_link }} class="mediabox rounded-[5px]
                            ...
                            <img src="{{ asset('assets/image/play_Svg.svg') }}" class="absolute max-w-[46px] top-[44%] right-[45%] " />
                        </a>
                    </div>
