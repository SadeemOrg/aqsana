...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        ...
        <!--Form -->
        <form method="POST" target="_self" action="{{ '/user/update' }}" enctype="multipart/form-data" class="ProfileForm mt-8">
            @csrf
            ...
            <div class="mt-8">
                ...
                <section class="border-b-2 max-w-7xl border-[#9CA9B6] pb-12">
                    ...
                    <div
                        ...
                        <div class="">
                            <label for="start_work_date" class="block text-sm mr-4 text-[#349A37] font-FlatBold"> بدء العمل
                                بالجمعية
                            </label>
                            <div class="mt-1">
                    ...
                    <div
                        class="mt-8 flex flex-row items-center justify-center lg:justify-start xl:flex-nowrap flex-wrap gap-y-4 gap-x-6">
                        <div class="">
                            <label for="martial_status" class="block text-sm mr-4 text-[#349A37] font-FlatBold"> الحالة
                                الاجتماعية
                            </label>
                            <div class="mt-1">
                ...
                <section class="border-b-2 max-w-7xl border-[#9CA9B6] pb-12">
                    ...
                    <div
                        ...
                        <div class="">
                            <label for="account_number" class="block text-sm mr-4 text-[#349A37] font-FlatBold">رقم الحساب
                            </label>
                            <div class="mt-1">
                ...
                <section class="border-b-2 max-w-7xl border-[#9CA9B6] pb-12">
                    ...
                    <div
                        ...
                        <div class="">
                            <label for="Confirm_password" class="block text-sm mr-4 text-[#349A37] font-FlatBold">تأكيد كلمة
                                المرور
                                الجديدة
                            </label>
                            <div class="mt-1">
