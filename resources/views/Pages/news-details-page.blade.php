...
@section('content')
    ...
    @else
        @php
            $imageVideoCover =
                'https://c.ndtvimg.com/2022-04/e0ei6018_jerusalem-al-aqsa-mosque-afp-650_625x300_29_April_22.jpg';
        @endphp
    @endif
    <style>
        .leftline1 {
        ...
        <div class="max-w-7xl mx-auto px-4  sm:px-6 lg:px-8">
            ...
            <div class="p-3 bg-white Card_shadow mt-4 lg:mt-16 relative flex flex-col items-center justify-center w-full">
                ...
                <div class="max-w-6xl bg-[#E4FFE585] rounded-[5px] py-3 px-4 ">
                    ...
                    <div
                        class="flex flex-col sm:flex-row items-start gap-y-3 sm:gap-y-0 sm:items-center justify-start px-4 pt-4 pb-10 font-noto_Regular gap-x-2">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="25"
                                        ...
                                        <defs>
                                            <clipPath id="clip0_21_1202">
                                                <rect width="11.8834" height="11.8834" fill="black"
                            ...
                            <li>
                                <a href="{{ $whatsapp_phone_Link }}" class="whatsApp">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25"
                                        viewBox="0 0 50 50" style=" fill:black;">
                                        <path
