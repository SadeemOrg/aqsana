    ...
    <div class="max-w-7xl mx-auto px-4  sm:px-6 lg:px-8">
        ...
        <div class="p-3 bg-white Card_shadow mt-4 lg:mt-16 relative flex flex-col items-center justify-center w-full">
            ...
            <div class="max-w-6xl bg-[#E4FFE585] rounded-[5px] py-3 px-4 ">
                ...
                <div class="flex flex-col sm:flex-row items-start gap-y-3 sm:gap-y-0 sm:items-center justify-start px-4 pt-4 pb-10 font-noto_Regular gap-x-2">
                    <p class="text-[#101426] text-sm">شارك عبر</p>
                    <ul class="share-us flex flex-row items-center justify-start gap-x-2">
                        <li>
                            <a class="facebook" target="_self" href="javascript:openWindow('http://www.facebook.com/sharer/sharer.php?u={{ Request::url() }}&title=')">
                        ...
                        <li>
                            <a class="twitter" target="_self" href="javascript:openWindow('http://twitter.com/intent/tweet?text=+{{ Request::url()  }}')">
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="12.1687" cy="12.1687" r="11.6687" stroke="#101426" />
                        ...
                        <li>
                            <a class="linkedin" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url={{ Request::url()  }}">
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="12.1687" cy="12.1687" r="11.6687" stroke="#101426" />
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 ">
                    ...
                    <div class="img-thumbnail">
                        <a href="{{ asset($picture['url']) }}">
                            <img class="mx-auto w-full object-cover lg:h-[265px] rounded-[5px]" src="{{ asset($picture['url']) }}" alt="related image">
                        </a>
                    </div>
                    @endforeach
