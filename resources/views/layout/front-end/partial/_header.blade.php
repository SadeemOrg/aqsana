            ...
            <div class="rt-links basis-2/5  text-base text-[#101426] cursor-pointer text-[15px] xl:text-[16px]" >
                <nav class="">
                    <ul class="navbar-nav xl:flex xl:flex-row justify-between items-center">
                        ...
                        <li class="nav-item relative">
                            <a class="stop-link w-[250px] xl:w-auto mb-3 xl:mb-0 xl:hover:text-[#349A37] bg-[#349A37] xl:bg-transparent text-white xl:text-[#000] block py-3 px-4 xl:py-0 xl:px-0  xl:inline-block relative xl:static" href="/our-project">مشاريعنا</a>
