<div dir="rtl" class="flex flex-col lg:flex-row justify-center py-4 lg:justify-between  items-center gap-x-10">
    ...
    <div class=" h-[432px] basis-1/2 w-full mr-10 lg:mr-0">
            <div class=" ltr pt-10 mr-4 lg:mr-0">
                <input type="text" name="" placeholder=" الاسم الكامل"
                    class="rtl block w-[80%]  border-[#A2A6B0] border rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-4">
            </div>
            <div class=" ltr pt-6 mr-4 lg:mr-0">
                <input type="text" name="" placeholder="رقم الهاتف"
                    class="rtl block w-[80%] border-[#A2A6B0] border rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-4">
            </div>
            <div class="  pt-6 mr-4 lg:mr-0">
                <textarea rows="4" name="order_note" id="order_note" placeholder="ملاحظة" required=""
                    class="w-[80%] inline-flex items-center text-right  justify-center border-[#A2A6B0] border rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-4"></textarea>
            </div>
        <div class=" my-4">
