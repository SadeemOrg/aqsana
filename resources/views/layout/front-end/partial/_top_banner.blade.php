        ...
        @foreach ($Heros as $Hero)
            <div class="relative ">
                ...
                <button onclick="window.open('{{ $Hero['data']['link'] }}')"
                    class="absolute bottom-[8%] right-[8%] Ctnbtn rounded-[50px] bg-[#349A37] text-white text-base sm:text-xl w-[100px] sm:w-[150px] md:w-[200px] py-4 font-[700] hover:bg-[#101426] duration-200">
                    تبرع
                    الان</button>
            </div>
        @endforeach
