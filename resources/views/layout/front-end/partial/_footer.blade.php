...
<footer class="bg-[#101426] text-white mt-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-start">
        ...
        <div class="hidden sm:flex flex-row flex-wrap justify-around items-center gap-7 pt-9">
            ...
            <a target="_self" class="text-[16px] hover:text-[#349A37] duration-200" href={{ $navfooter->data->link->id }}>{{
        ...
        <div class="flex flex-row justify-between gap-x-6 sm:hidden mt-6 text-right w-full">
            <div class="flex flex-col items-start justify-start text-right gap-y-2 text-[10px] ">
                ...
                @if($key < count($navfooters)/2) <a target="_self" class="text-[14px] text-right hover:text-[#349A37] duration-200"
            ...
            <div class="flex flex-col items-start justify-start  gap-y-2 text-[10px] ">
                ...
                <a target="_self" class="text-[14px] hover:text-[#349A37] duration-200" href={{ $navfooter->data->link->id }}>{{
                    $navfooter->data->name }}</a>
                @endif
                @endforeach
                @endif
