...
<footer class="bg-[#101426] text-white mt-24">
    ...
    @endphp
        <img src="{{ $img }}" class="w-[165px] pt-10 h-[125px]" />
        ...
        <div class="flex flex-row justify-between gap-x-6 sm:hidden mt-6 text-right w-full">
            <div class="flex flex-col items-start justify-start text-right gap-y-2 text-[10px] ">
                <a class="text-[14px] text-right hover:text-[#349A37] duration-200" href="#">من نحن</a>
                <a class="text-[14px] text-right hover:text-[#349A37] duration-200" href="#">مشاريعنا</a>
                <a class="text-[14px] text-right hover:text-[#349A37] duration-200" href="#">اخبارنا</a>
                <a class="text-[14px] text-right hover:text-[#349A37] duration-200" href="#">القدس والمسجد الاقصى</a>
            </div>
            <div class="flex flex-col items-start justify-start  gap-y-2 text-[10px] ">
                <a class="text-[14px] hover:text-[#349A37] duration-200" href="#">الاوقاف والمقدسات</a>
                <a class="text-[14px] hover:text-[#349A37] duration-200" href="#">حصاد الحمعية</a>
                <a class="text-[14px] hover:text-[#349A37] duration-200" href="#">التبرع للمشاريع</a>
