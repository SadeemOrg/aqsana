            ...
            <div
                ...
                <div class="max-w-[600px] bg-[#E4FFE585] rounded-[5px] py-3 px-4 ">
                    ...
                    <p class="text-xs text-[#101426] font-noto_Regular pl-4 pt-2 text-right slider-paragraph">
                        {{ Illuminate\Support\Str::limit(strip_tags( $Project->report_title),240) }}
                        @if(strip_tags(Str::length($Project->report_title)) > 240)
                        <a href="/" target="_self">
                    ...
                    <div class="flex flex-wrap justify-center sm:justify-between items-center mt-5">
                        <div class="flex text-center">
                            ...
                            href="{{ route('getdonationDetail', ['id' => $Project->id]) }}" target="_self">رؤية التفاصيل</a>
                        </div>
                        <div
                            ...
                            <ul class="share-us flex flex-row items-center justify-start">
                                ...
                                <li class="px-1">
                                    <a class="linkedin lisharelink" data-shareurl={{ Request::url() }} data-id={{ $Project->id}} >
                                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="12.1687" cy="12.1687" r="11.6687" stroke="#101426" />
                                            <path
