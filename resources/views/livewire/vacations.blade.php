        ...
        <div
            ...
            <div class="grid grid-cols-1 gap-3 md:gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-4 ">
                ...
                <div dir="ltr" class="relative h-12">
                    <div
                        class="svgFoucusAdminVicationFrom absolute inset-y-0 left-0 flex mb-1 items-center pl-3 pointer-events-none">
                    ...
                    <input wire:model.debounce.50000ms="FromDate" id="hidePlaceHolderDateAdminVicationFrom" type="text"
                ...
                <div dir="ltr" class="relative h-12">
                    <div
                        class="svgFoucusVicationAdminTo absolute inset-y-0 left-0 flex mb-1 items-center pl-3 pointer-events-none">
                        <svg aria-hidden=" true" class="w-5 h-5 text-[#349A37] " fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z"
                                    ...
                                    <td
                                        ...
                                        <div class="flex flex-row items-center gap-x-2">
                                            <svg class="cursor-pointer"
                                                wire:click="showEditModels({{ $vacation->id }})"
                                            ...
                                            <svg class="cursor-pointer"
                                                wire:click="Delete({{ $vacation->id }})" width="35"
                    ...
                    <div
                        ...
                        <form class="Wraper2" wire:submit.prevent="EditVacation">
                            ...
                            <div class="mt-2 selectdiv">
                                ...
                                <option   value={{ str_replace(' ', '_', $Reasons->attributes->Reasons_to_vacations);}}>
                ...
                <div
                    ...
                    <div
                        ...
                        <form class="Wraper2" wire:submit.prevent="AddDay">
                            ...
                            <!--First One -->
                            <div class="mt-2 selectdiv ">
                                <select  wire:model.debounce.50000000000ms="userId" name="userId"
