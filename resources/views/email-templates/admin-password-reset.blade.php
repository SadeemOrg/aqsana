...
<body style="width: 100% !important; height: 100% !important; padding: 0 !important; margin: 0 !important; background-color: #f3f4f6; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif;">
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 24px; border-top: 3px solid #d4dadf;" class="container">
        <div style="text-align: center; padding: 36px 0;" class="logo">
            <a href="https://aqsana.org" target="_blank">
                <img src="{{ asset('assets/image/QawafelLogo.png') }}" alt="Logo" style="width: 100px; height: auto;">
            </a>
        </div>
        <div style="border: 2px solid #e9ecef; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 46px 24px; border-radius: 10px; background-color: white;" class="content">
            <h1 style="font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px; margin: 0;">إعادة تعيين كلمة المرور</h1>
            <div style="text-align: center; padding: 12px 0;" class="button-container">
                <a href="https://aqsana.org/app/password/reset/{{ $token }}" target="_blank" style="font-size: 16px; font-weight: 700; color: #ffffff; text-decoration: none; background-color: #1a82e2; border-radius: 6px; padding: 10px 20px; display: inline-block;" class="button">إعادة تعيين كلمة المرور</a>
            </div>
