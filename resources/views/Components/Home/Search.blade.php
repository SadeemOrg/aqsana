        ...
        <div dir="rtl" class=" relative shadow-sm  w-full bg-white border-0 h-full  rounded-md">
            <form class="h-full w-full" action="{{ route('pagesearch') }}" method="get">
                <div class="absolute inset-y-0 right-10 pl-3 hidden sm:flex items-center pointer-events-none">
                    ...
                    <svg class="hidden sm:flex" width="20" height="20" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <input type="search" name="search" id="search"
                    class="search-bar h-16 sm:h-full px-8 sm:px-20 shadow-sm   block w-full bg-white border-0 sm:text-sm rounded-md focus:ring-[#349A37] focus:border-[#349A37]"
                ...
                <div
                    class="card absolute bg-green-50 search-card z-10 my-2 h-40 overflow-auto w-full lg:w-[65%] top-[100%] right-0 rounded shadow hidden">
