...
<div class="max-w-7xl mx-auto px-4 mt-24 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div class="tabs-btn flex flex-col items-center justify-center gap-y-3">
            @foreach ($ProjectsNews as $key=>$ProjectsNew)
            @php
            $tab='tab-'.(++$key);
            // dd($ProjectsNew['data']);
            @endphp
            <div class="tab-btn w-full newsShaddow px-4 py-3" data-tab={{ $tab }}>
                <div
                    class="news-title cursor-pointer flex flex-row justify-between items-center text-lg font-FlatBold text-right text-[#101426]  bg-white ">
                    <p class="max-w-[90%]">
                        {{ $ProjectsNew['data']['title'] }}
                        {{-- أكثر من 10 آلاف مشارك بمعسكر “القدس أولًا 13” --}}
                    </p>
                    <svg class="md:block duration-200 arrow-icon" width="11" height="17" viewBox="0 0 11 17" fill="none"
                ...
                <div class="news-text hidden mt-3">
                    <p>
                        {{ $ProjectsNew['data']['sup_title'] }}
                        {{-- أكثر من 10 آلاف مشارك بمعسكر “القدس أولًا 13 أكثر من 10 آلاف مشارك بمعسكر “القدس أولًا 13
                        --}}
                    </p>
                </div>
            </div>
        ...
        <div class="tabs-container mt-5 lg:mt-0">
            ...
            <div class="tab {{ $tab }}">
                <img src="{{ asset($ProjectsNew['data']['image']) }}" alt="Rock_Mousq"
                    class="lg:max-h-[450px] max-h-[400px] m-auto  max-w-[650px]">
            </div>
            @endforeach

            {{-- <div class="tab tab-2">
                <img src="{{ asset('assets/image/image10.png') }}" alt="Rock_Mousq"
                    class=" lg:max-h-[450px] max-h-[400px] m-auto">
            </div>
            <div class="tab tab-3">
                <img src="{{ asset('assets/image/Rock_Mousq.png') }}" alt="Rock_Mousq"
                    class=" lg:max-h-[450px] max-h-[400px] m-auto ">
            </div>
            <div class="tab tab-4">
                <img src="{{ asset('assets/image/Rock_Mousq.png') }}" alt="Rock_Mousq"
