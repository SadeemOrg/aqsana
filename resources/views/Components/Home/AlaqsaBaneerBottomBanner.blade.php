...
@php
$imgBanner2 = 'storage/'.nova_get_setting('main_img_Banner_2', 'default_value');
    ...
    <div class="relative max-w-7xl mx-auto sm-py-12 py-11 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col items-center justify-center gap-y-2 md:justify-between relative">
            <div class="text-right font-FlatBold text-white">
                <p class="text-[24px] md:text-[36px] pb-4 text-center max-w-[560px]">
                {{ $main_text_Banner2 }}
                </p>
                <div class="flex flex-row flex-wrap items-center justify-center">

                    <a href='{{ $link_View }}' target="_blank" class="flex gap-x-2 justify-center items-center bg-white text-[#101426] w-[150px] h-[60px] sm:w-[168px] sm:h-[63px] rounded-[5px] ml-3 hover:text-[#fff] hover:bg-[#101426] duration-200">
                        ...
                        <span class="text-[20px] sm:text-[24px] font-[500] ">{{ $view_Number }}</span>
                    </a>
                    {{-- <button class="flex justify-center items-center bg-white text-[#101426] w-[150px] h-[60px] sm:w-[168px] sm:h-[63px] rounded-[5px] hover:text-[#fff] hover:bg-[#101426] duration-200">
                        ...
                        <span class="text-[20px] sm:text-[24px] font-[500] mr-2">{{ $seen_button }}</span>
                    </button> --}}
