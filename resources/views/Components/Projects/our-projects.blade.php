...
<div dir="rtl" class="max-w-7xl mx-auto px-4 mt-8 lg:mt-32 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-6">
        <!--first card -->
        <div class="p-3 bg-white Card_shadow mt-4 lg:mt-16 relative flex flex-col items-center justify-center w-full" onclick="location.href='our-project/1'">
            ...
            <div class="max-w-[600px] bg-[#E4FFE585] rounded-[5px] py-3 px-4 ">
                ...
                <p class="text-xs text-[#101426] font-noto_Regular px-4 pt-2">
        ...
        <div class="flex flex-col items-center justify-center w-full">
            <div class="p-3 bg-white Card_shadow mt-8 lg:mt-16 relative ">
                <div class="absolute leftline hidden lg:block"></div>
                <div class=" max-w-[600px] bg-[#E4FFE585] rounded-[5px] py-3 px-4">
                    <img src="{{ asset('assets/image/Alquds_First.png') }}" alt="people_on_Mousq"
                        class="w-full lg:w-[550px] lg:max-h-52">
                    <p class="text-[#349A37] text-[16px] pt-4 text-right max-w-[480px] px-4">
