...
<div class="bg-[#F2FFF285] py-16 mt-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="lg:grid lg:grid-cols-2 gap-x-8 gap-y-6 text-center lg:text-right">
            <!--first card -->
            <div class="p-3 bg-white Card_shadow mt-4 lg:mt-16 relative inline-block lg:flex flex-col items-center justify-center " onclick="location.href='our-project/1'">
            ...
            <!--second card -->
            <div class="p-3 bg-white Card_shadow mt-4 lg:mt-16 relative inline-block lg:flex flex-col items-center justify-center" onclick="location.href='our-project/2'">
                <div class="absolute leftline"></div>
                <div class="max-w-[600px] bg-[#E4FFE585] rounded-[5px] py-3 px-4 ">
                    <img src="{{ asset('assets/image/Alquds_First.png') }}" alt="people_on_Mousq"
                        class="w-full lg:w-[550px] lg:max-h-52">
            ...
            <!--third card -->
            <div class="p-3 bg-white Card_shadow mt-4 lg:mt-16 relative inline-block lg:flex flex-col items-center justify-center">
                <div class="absolute leftline"></div>
                <div class=" max-w-[600px] bg-[#E4FFE585]  rounded-[5px] py-3 px-4">
                    <img src="{{ asset('assets/image/Alquds_First.png') }}" alt="people_on_Mousq"
                        class="w-full lg:w-[550px] lg:max-h-52">
