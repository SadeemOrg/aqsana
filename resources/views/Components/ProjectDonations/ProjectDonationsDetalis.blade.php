    ...
    <form target="_self" class="submitButton space-y-6" id="donationForm">
        @csrf
        ...
        <div class="flex flex-col items-start gap-y-6">
            <div class="flex flex-row items-center">
                <div class="mt-10 firstPage">
                    <label for="price" class="block text-sm font-medium text-gray-700 pr-1">المبلغ المراد التبرع
                        בו</label>
            ...
            <div class="firstPage pt-6 lg:px-0 w-[220px] lg:w-[80%]">
                <label for="donationAim" class="pr-1 block text-sm font-medium text-gray-700">سبب התברנות</label>
                <textarea rows="4" name="donationAim" id="order_note" placeholder="سبب התبرع" required
    ...
    <script>
        document.getElementById('submitButton').addEventListener('click', function(event) {
            event.preventDefault(); // Use "event" here to prevent the default action
            var $donation_amount = $('input[name="donation_amount"]').val();
            var $donationAim = $('textarea[name="donationAim"]').val();
            var $privecy = $('input[name="privecy"]').prop('checked'); // Check if the checkbox is checked
            ...
            $.ajax({
                ...
                success: function(data) {
                    if ($.isEmptyObject(data.error)) {
                        ...
                        data.error.forEach(function(errorMessage) {
                            toastr.error(
                            errorMessage);
                        });
                    }
            ...
            // The rest of your AJAX logic can go here...
        });
    </script>
