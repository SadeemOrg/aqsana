    ...
    <form target="_self" class="submitButton space-y-6" id="donationForm">
        ...
        <div class="flex flex-col items-start gap-y-6">
            ...
            <!-- PayPal Button -->
            <button type="button" id="submitButton" class="w-sm flex bg-[#349a37] justify-center items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white  hover:text-base focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
