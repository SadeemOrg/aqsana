...
@endphp
<div  class="max-w-7xl mx-auto px-4 mt-8 md:mt-12 sm:px-6 lg:px-8">
    <div itemscope itemtype="https://schema.org/Organization"
        ...
        <img itemprop="image" src="{{ asset($vision_section_image) }}" alt="AlAqsaView"
            class="xl:basis-2/5 max-w-[550px] max-h-[460px] xl:block hidden" />
        <div class="flex flex-col xl:basis-3/5 xl:mt-24 justify-center items-center xl:items-start h-full">
            <div itemscope itemtype="https://schema.org/Organization" class="relative">
                <p itemprop="name" class="font-FlatBold text-3xl text-center xl:text-right"> {{ $vision_main }}</p>
                <div class="absolute border-b-[4px] pt-2 border-b-[#349A37] w-7 hidden xl:block"></div>
            </div>
                  <img itemprop="image" src="{{ asset('assets/image/AlAqsaView.png') }}" alt="AlAqsaView"
                class="block xl:hidden mt-10 object-cover" />
            <p itemprop="name" class="max-w-2xl pt-9 font-noto_Regular text-base sm:text-lg text-justify md:text-right">
