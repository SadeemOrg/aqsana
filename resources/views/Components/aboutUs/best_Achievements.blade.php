...
<div dir="rtl" class="max-w-7xl mx-auto px-4 pt-12 lg:pt-32 sm:px-6 lg:px-8">
    <div
        ...
        <div class="flex flex-col  xl:basis-3/5 justify-center items-center xl:items-start">
            ...
            <img src="{{ asset('assets/image/AlaqsaSun.png') }}" alt="AlaqsaSun"
            ...
            <p class="dashedBefore max-w-2xl pt-9 font-noto_Regular text-base sm:text-lg text-justify sm:text-right text-[#101426]">
                ترميم وإعادة فتح المصلى المرواني خلال العامين 1996 و 1997 م الذي يقع تحت المسجد الأقصى، وقد كان مغلقً ا
