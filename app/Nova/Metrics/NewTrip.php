...
class NewTrip extends Value
{
    ...
    public function calculate(NovaRequest $request)
    {
        ...
        if ($user->type() == 'admin') {
            ...
            return $this->count($request, Project::where('project_type', 3));
        ...
        return $this->count($request, Project::where('project_type', 3)->whereIn('id', $stack));
    }
