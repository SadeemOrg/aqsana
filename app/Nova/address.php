    ...
    NovaBelongsToDepend::make(__('City'),'City', \App\Nova\City::class)
        ...
        ->options(function () {
            ...
            //     ->zoom(8),
                ...
                MapsAddress::make(__('Address'), 'current_location') ->zoom(10)->center(['lat' =>  31.775947, 'lng' => 35.235577]) ->types(['address' ,'establishment'])->mapOptions(['fullscreenControl' => true,'clickableIcons'=>true,'restriction'=>true]),
